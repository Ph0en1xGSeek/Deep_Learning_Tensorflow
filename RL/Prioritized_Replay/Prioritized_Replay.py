...
class DQNPrioritizedReplay:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            self.q_eval = build_layers(self.s, c_names, n_l1, w_initializer, b_initializer, trainable=True)
        ...
        with tf.variable_scope('target_net'):
            ...
            self.q_next = build_layers(self.s_, c_names, n_l1, w_initializer, b_initializer, trainable=False)
...
#     dqn = DQNPrioritizedReplay(3, 4, output_graph=False)